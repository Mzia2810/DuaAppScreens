...
const Settings = ({ navigation }) => {
  ...
  const Item = ({ title }) => (
    <View style={{ paddingHorizontal: 20, marginVertical: 5 }}>
      <Text    onPress={() => setSelectFont(!selectFont)} style={{ fontSize: 10, lineHeight: 15, fontWeight: "400", }}>
        {title}
      </Text>
    </View>
  );
    ...
    <View style={[styles.container]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <TouchableOpacity>
            <View style={{ flexDirection: "row" }}>
              <View style={{ paddingRight: wp("5%"), paddingLeft: wp("2%"),paddingBottom:hp('2%') }}>
          ...
          >
            ...
            <View style={{ alignSelf: "flex-end" }}>
              ...
              >
                <TouchableOpacity>
                  <ImageBackground
                    style={{ width: wp("5%"), height: hp("3%"),borderRadius:'100% ', }}
